...
$query = '
    SELECT ccd.*, s.name as student_name, s.guardian_name, s.student_id as student_id_number, s.course as student_course, s.status as student_status, s.year as student_year, s.address as student_address, u.name as teacher_name, pur.undrop_remarks, pur.retrieve_date as undrop_retrieve_date
...
<body>
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="submenu active" id="historySubmenu">
                    <a href="/CLASS_CARD_DROPPING_SYSTEM/frontend/teacher/drop_history.php" class="submenu-item <?php echo !$year_filter ? 'active' : ''; ?>">All Records</a>
                    <a href="/CLASS_CARD_DROPPING_SYSTEM/frontend/teacher/drop_history.php?year=1" class="submenu-item <?php echo $year_filter === 1 ? 'active' : ''; ?>">1st Year</a>
                    <a href="/CLASS_CARD_DROPPING_SYSTEM/frontend/teacher/drop_history.php?year=2" class="submenu-item <?php echo $year_filter === 2 ? 'active' : ''; ?>">2nd Year</a>
                    <a href="/CLASS_CARD_DROPPING_SYSTEM/frontend/teacher/drop_history.php?year=3" class="submenu-item <?php echo $year_filter === 3 ? 'active' : ''; ?>">3rd Year</a>
                    <a href="/CLASS_CARD_DROPPING_SYSTEM/frontend/teacher/drop_history.php?year=4" class="submenu-item <?php echo $year_filter === 4 ? 'active' : ''; ?>">4th Year</a>
                </div>
            ...
            <div class="content-wrapper">
                ...
                <section class="section">
                    ...
                    <?php if (count($drops) > 0): ?>
                        ...
                        <?php echo renderPaginationControls($pagination, '/CLASS_CARD_DROPPING_SYSTEM/frontend/teacher/drop_history.php'); ?>
                    <?php else: ?>
    ...
    <script>
        ...
        function showStudentDetailModal(dropData) {
            ...
            const retrieveDate = dropData.undrop_retrieve_date && dropData.undrop_retrieve_date !== '0000-00-00 00:00:00' ? dropData.undrop_retrieve_date : 'N/A';
