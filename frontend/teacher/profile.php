...
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/CLASS_CARD_DROPPING_SYSTEM/frontend/teacher/settings.php" class="nav-item active">
                    <span>Profile</span>
                </a>
                ...
                <div style="background: white; border: 1px solid #e5e5e5; border-radius: 10px; padding: 30px; margin-bottom: 25px; max-width: 600px;">
                    ...
                    <div style="display: grid; gap: 20px;">
                        ...
                        <div>
                            ...
                            <p style="margin: 8px 0 0 0; color: #333; font-size: 0.95em;"><?php echo htmlspecialchars($teacher_info['email']); ?></p>
                        </div>

                        <div>
                            <p style="margin: 0; color: #999; font-size: 0.85em; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Department</p>
                            <p style="margin: 8px 0 0 0; color: #333; font-size: 0.95em;"><?php echo htmlspecialchars($teacher_info['department'] ?: 'N/A'); ?></p>
                        </div>

                        <div>
                            <p style="margin: 0; color: #999; font-size: 0.85em; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Address</p>
                            <p style="margin: 8px 0 0 0; color: #333; font-size: 0.95em;"><?php echo htmlspecialchars($teacher_info['address'] ?: 'Not specified'); ?></p>
                        </div>
                    </div>
                </div>
    ...
    <div id="editProfileModal" class="profile-modal">
        <div class="profile-modal-box">
            ...
            <div class="profile-modal-body">
                <form method="POST" action="../../backend/includes/api.php?action=update_profile" id="editProfileForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="modal_address" name="address" required rows="3" placeholder="Your address"><?php echo htmlspecialchars($teacher_info['address'] ?: ''); ?></textarea>
                    </div>
    ...
    <div id="changePasswordModal" class="profile-modal">
        <div class="profile-modal-box">
            ...
            <div class="profile-modal-body">
                <form method="POST" action="../../backend/includes/api.php?action=update_password" id="changePasswordForm">
                    <div class="form-group">
